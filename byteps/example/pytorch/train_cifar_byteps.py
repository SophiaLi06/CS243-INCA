...
######## Minghao: add additional options according to MXNET and pytorch imagenet
...
if args.new_inca:
    ...
    # compression = bps.Compression.newinca(params={'nclients': 2, 'd': pytorch_total_params_trainable, \
...
# Minghao: add learning rate scheduler for Cifar100
...
if args.save_lr_accu:
    ...
    if args.dataset == 'CIFAR100':
        with open('../example/pytorch/accuracy_and_lr_record/cifar100/'+args.net+'-'+curr_time+'.pkl', 'wb') as pkl_file:
            pickle.dump(accuracy_and_lr, pkl_file)
    else:
        with open('../example/pytorch/accuracy_and_lr_record/cifar10/'+args.net+'-'+curr_time+'.pkl', 'wb') as pkl_file:
            pickle.dump(accuracy_and_lr, pkl_file)
